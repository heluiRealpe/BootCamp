...
<html lang="en">
<head>
    <title>Code coverage report for lib\locales\default\entity\index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/locales/default/entity/</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
	post(paragraphs = <span class="branch-1 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >3</span></span>) {
		return {
