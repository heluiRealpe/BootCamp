...
<html lang="en">
<head>
    <title>Code coverage report for lib\locales\default\date\index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/locales/default/date/</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
	past(years = 1, refDate) {
		let date = r</span>efDate ? <span class="branch-0 cbranch-no" title="branch not covered" >new Date(Date.parse(refDate)) : new Date();
		let min = 1000;
