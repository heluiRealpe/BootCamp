...
<html lang="en">
<head>
    <title>Code coverage report for lib\locales\hu-HU\internet\index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/locales/hu-HU/internet/</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
	email(firstName, lastName, domain) {
		firstName = this.slugify(firstName ? firstName : this.populate("#{names.firstName}")).toLowerCase();
		lastName = this.slugify(lastName ? lastName : this.populate("#{names.lastName}")).toLowerCase();
		domain = d</span>omain ? <span class="branch-0 cbranch-no" title="branch not covered" >domain : this.populate("#{internet.emailDomain}");
&nbsp;
		return [
