...
//     if (err) throw err;
//     console.log("La nota de todos los estudianes a 0");
//     console.log(result);
// });
...
// connection.query(sql, (err, result) => {
//     if (err) throw err;
//     console.log("La lista de todos los estudianes por nombre y apellido es:");
//     console.log(result);
// });
...
// connection.query(sql, (err, result) => {
//     if (err) throw err;
//     console.log("La lista de todos los profesores es:");
//     console.log(result);
// });
